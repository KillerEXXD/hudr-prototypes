    ...
    <Sheet open={open} onClose={onClose} title="Add a final table">
      ...
      <div className="flex flex-col gap-2.5">
        ...
        <div className="grid grid-cols-3 gap-2">
          ...
          <Field label="Buy-in (Stakes)" value={m.buyIn} onChange={(v) => setM({ ...m, buyIn: v })} placeholder="10,000" />
        </div>
        <Field label="Prize pool (Stakes)" value={m.prizePool} onChange={(v) => setM({ ...m, prizePool: v })} placeholder="5,000,000" />
      </div>
