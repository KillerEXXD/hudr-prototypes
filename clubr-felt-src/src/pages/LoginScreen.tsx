...
const ROLES: { role: AccountRole; label: string; who: string; icon: typeof UserIcon; color: string; userId?: string }[] = [
  ...
  { role: 'host', label: 'Aces High Host', who: 'Harper · owns "Aces High", approves members', icon: Crown, color: '#10b981' },
    ...
    <div className="flex min-h-screen items-center justify-center bg-bg-primary px-5">
      <div className="w-full max-w-md">
        <div className="mb-7 text-center">
          ...
          <h1 className="mt-3 text-3xl font-extrabold tracking-tight text-text-primary" style={{ fontFamily: 'var(--font-family-display)' }}>Clubr<span className="text-accent-gold">GO</span></h1>
