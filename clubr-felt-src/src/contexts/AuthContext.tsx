...
function readStored(): User | null {
  ...
  // Felt variant: open signed-in as the demo Player (Sam Rivers), matching the
  // captured screenshots. LoginScreen is still reachable after Sign out.
  return USERS['u_player'] ?? null
}
