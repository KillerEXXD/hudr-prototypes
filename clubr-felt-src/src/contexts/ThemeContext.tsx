...
function readStored(): ThemeName {
  // Locked variant: always Felt. We ignore any persisted skin so a skin chosen in a
  // sibling prototype on the same origin can never bleed in, and there's no picker.
