...
export const TOURNAMENTS_LIST: Tournament[] = [
  ...
  { id: 't2', name: 'WPT Legends', event: 'World Poker Tour', venue: 'Commerce Casino', date: 'March 2025', players: 8, hands: 62, prize: 25000000, live: true, status: 'live', aiReports: ['insights', 'players', 'story'], exploitable: 3, leaks: 31, rivalries: 4, topPlayers: ['p2', 'p4', 'p6', 'p7'], winner: null, duration: '2h 48m', youtubeId: 'BfjYdODQu9Q' },
  { id: 't3', name: 'EPT Barcelona', event: 'European Poker Tour', venue: 'Casino Barcelona', date: 'August 2025', players: 9, hands: 95, prize: 42000000, live: false, status: 'completed', aiReports: ['insights', 'players', 'story', 'commentary'], exploitable: 5, leaks: 52, rivalries: 8, topPlayers: ['p5', 'p3', 'p9', 'p1'], winner: 'p5', duration: '5h 10m', youtubeId: 'WrnZdEdZD4I' },
  ...
  { id: 't6', name: 'PCA Main Event', event: 'PokerStars', venue: 'Atlantis Bahamas', date: 'January 2026', players: 9, hands: 0, prize: 35000000, live: false, status: 'upcoming', aiReports: [], exploitable: 0, leaks: 0, rivalries: 0, topPlayers: [], winner: null, duration: null, youtubeId: 'pDJEvlFoADY' },
  { id: 't7', name: 'Aussie Millions', event: 'Crown Melbourne', venue: 'Melbourne', date: 'February 2026', players: 8, hands: 0, prize: 28000000, live: false, status: 'upcoming', aiReports: [], exploitable: 0, leaks: 0, rivalries: 0, topPlayers: [], winner: null, duration: null, youtubeId: 'u7UUnrlnbbA' },
  { id: 't8', name: 'WSOP Europe', event: 'World Series of Poker', venue: "King's Casino Rozvadov", date: 'October 2025', players: 9, hands: 82, prize: 31000000, live: false, status: 'completed', aiReports: ['insights', 'players', 'story', 'quiz'], exploitable: 3, leaks: 36, rivalries: 5, topPlayers: ['p9', 'p3', 'p7', 'p1'], winner: 'p9', duration: '4h 05m', youtubeId: '-i6rCdZVVeg' },
  { id: 't9', name: 'WPT World Championship', event: 'World Poker Tour', venue: 'Wynn Las Vegas', date: 'December 2025', players: 6, hands: 58, prize: 40000000, live: false, status: 'completed', aiReports: [], exploitable: 0, leaks: 0, rivalries: 0, topPlayers: ['p4', 'p7', 'p8'], winner: 'p4', duration: '3h 12m', youtubeId: 'NWeocgkbzis' },
  { id: 't10', name: 'GPI Poker Masters', event: 'PokerGO', venue: 'Aria Las Vegas', date: 'April 2025', players: 8, hands: 0, prize: 15000000, live: true, status: 'live', aiReports: [], exploitable: 0, leaks: 0, rivalries: 0, topPlayers: ['p3', 'p8', 'p5', 'p7'], winner: null, duration: null, youtubeId: 'y7XEwU42kdw' },
]
