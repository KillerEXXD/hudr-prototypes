...
import type { Tournament, Player, Highlight, HandSummary, SuggestedQuestion, PlayerTournament, CurrentUser, SubscriptionPlan, TrendingQuery, StatHand } from '../domain'
...
export function transformStatHand(a: ApiStatHand): StatHand {
  return {
    handNumber: a.hand_number, statType: a.stat_type, actionTaken: a.action_taken,
    position: a.position, holeCards: a.hole_cards, board: a.board, pot: a.pot,
    result: a.result, netResult: a.net_result, videoSeconds: a.video_seconds,
    videoUrl: a.video_url, hasReplay: a.has_replay,
  }
}
