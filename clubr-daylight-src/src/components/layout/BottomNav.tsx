...
export function BottomNav() {
  ...
  return (
    <nav className="sticky bottom-0 z-30 border-t border-border bg-bg-card/95 backdrop-blur">
        ...
        {ITEMS.map((it) => {
          ...
          return (
            <button
              ...
              className={cn('flex flex-1 flex-col items-center gap-0.5 py-2.5 text-[10px] font-semibold transition-colors cursor-pointer', active ? 'text-accent-emerald' : 'text-text-muted hover:text-text-secondary')}
            >
