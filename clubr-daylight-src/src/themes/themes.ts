...
export const THEMES: Record<ThemeName, ThemeDef> = {
  ...
  felt: {
    name: 'felt', label: 'Daylight', tagline: 'Warm paper, calendar-first — the only light skin',
    flags: { serifHeadline: true },
    swatch: { bg: '#F7F3EA', accent: '#2F6F4F', text: '#1E2A24' },
    vars: {
      '--color-bg-primary': '#F7F3EA', '--color-bg-secondary': '#FBF8F1', '--color-bg-card': '#FFFFFF',
      '--color-bg-surface': '#F0EADC', '--color-bg-elevated': '#EAE3D2', '--color-border': '#E4DBC8', '--color-border-light': '#D6CBB2',
      '--color-text-primary': '#1E2A24', '--color-text-secondary': '#52605A', '--color-text-muted': '#8A938C',
      '--color-accent-blue': '#2F6F4F', '--color-accent-blue-deep': '#235740', '--color-accent-amber': '#C77D3A',
      '--color-accent-emerald': '#2F6F4F', '--color-accent-red': '#C0503C', '--color-accent-purple': '#7A5AA8', '--color-accent-cyan': '#2C8C8C',
      '--color-accent-gold': '#C77D3A', '--color-accent-gold-deep': '#A8632A',
      '--color-tier-reliable': '#2F6F4F', '--color-tier-tentative': '#C77D3A', '--color-tier-noise': '#8A938C',
      '--color-sev-critical': '#C0503C', '--color-sev-moderate': '#C77D3A', '--color-sev-minor': '#2F6F4F',
