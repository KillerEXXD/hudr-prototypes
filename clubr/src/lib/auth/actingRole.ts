...
export const ROLES: AccountRole[] = ['admin', 'owner', 'member']

// App Admin "acting as" view. A REAL admin views the app as Owner BY DEFAULT
...
export function applyActingRole(user: User | null, actingRole: AccountRole | null): User | null {
  ...
  const view: AccountRole = actingRole ?? 'owner' // admins default to the Owner view
