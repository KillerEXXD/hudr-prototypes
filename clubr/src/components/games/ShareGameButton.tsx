...
export function ShareGameButton({ type, gameId, size = 'sm', className }: { type: GameInviteType; gameId: string; size?: 'sm' | 'md'; className?: string }) {
  ...
  return (
    <Btn size={size} variant="secondary" onClick={copy} className={className}>
