...
import { captureFeedback, getIdentity, isEmail } from '@/lib/analytics'
import ReviewWizard from '@/components/common/ReviewWizard'

// Floating "Feedback" launcher + a short in-context form for the ClubR
// prototype. Captures the current screen automatically and sends a structured
// PostHog event (which links to the user's session replay). The longer guided
// review rates each ClubR feature. Pinned inside the centered phone frame,
// above the bottom nav. Present on every screen via AppShell.
