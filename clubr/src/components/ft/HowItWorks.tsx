  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <p className="mt-1 rounded-lg bg-bg-surface/60 p-2 text-[11px] leading-snug text-text-muted">
        ClubrGO is just the <strong className="text-text-secondary">scorekeeper</strong> — it tracks picks &amp; results transparently and <strong className="text-text-secondary">holds no cash</strong>. All stakes are settled between players offline.
      </p>
    </div>
  )
}
