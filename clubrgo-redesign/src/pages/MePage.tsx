    ...
    <div className="animate-fade-up">
      ...
      <Section title="Appearance" action={<Palette className="h-4 w-4 text-text-muted" />}>
        <Card className="flex items-center gap-3">
          <span className="grid h-9 w-9 place-items-center rounded-lg bg-gradient-to-br from-accent-violet to-accent-blue text-white shadow-lg">♣</span>
          <div className="flex-1"><p className="text-sm font-bold text-text-primary">Nocturne</p><p className="text-xs text-text-muted">Dark &amp; premium — the one ClubrGo skin</p></div>
          <span className="rounded-full bg-accent-emerald/15 px-2 py-0.5 text-[10px] font-bold text-accent-emerald">Active</span>
        </Card>
      </Section>
