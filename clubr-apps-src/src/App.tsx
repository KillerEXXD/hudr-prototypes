...
import { FantasyAppPage } from '@/pages/FantasyAppPage'
import { LastLongerAppPage } from '@/pages/LastLongerAppPage'
  ...
  return (
    <Routes>
      <Route element={<AppShell />}>
        ...
        <Route path="/fantasy" element={<FantasyAppPage />} />
        ...
        <Route path="/lastlonger" element={<LastLongerAppPage />} />
