...
export const THEMES: Record<ThemeName, ThemeDef> = {
  ...
  felt: {
    name: 'felt', label: 'Golden - Real', tagline: 'The real ClubrGo — premium poker-luxe',
    flags: { goldRule: true },
    swatch: { bg: '#0B0F17', accent: '#E9C46A', text: '#F3F6F2' },
    vars: {
      '--color-bg-primary': '#0B0F17', '--color-bg-secondary': '#070A11', '--color-bg-card': '#121826',
      '--color-bg-surface': '#1A2234', '--color-bg-elevated': '#222C42', '--color-border': '#243049', '--color-border-light': '#33425F',
      '--color-text-primary': '#F3F6F2', '--color-text-secondary': '#A9B6CC', '--color-text-muted': '#6B7A93',
      '--color-accent-blue': '#4A90E2', '--color-accent-blue-deep': '#2E6FA3', '--color-accent-amber': '#E9C46A',
      ...
      '--color-tier-reliable': '#36C98B', '--color-tier-tentative': '#E9A23B', '--color-tier-noise': '#6B7A93',
      '--color-sev-critical': '#E5604F', '--color-sev-moderate': '#E9A23B', '--color-sev-minor': '#4A90E2',
