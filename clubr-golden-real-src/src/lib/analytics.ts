...
/**
 * Onboarding funnel event — fired once each time a user first reaches a
 * progressive-disclosure stage (fresh → connected → settled). Used by
 * useOnboardingStage to track where the slow-reveal ladder leaks.
 */
