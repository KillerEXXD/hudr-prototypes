        ...
        {ITEMS.map((it) => {
          ...
          return (
            <button
              ...
              className={cn('flex flex-1 flex-col items-center gap-0.5 py-3 text-[11px] font-semibold transition-colors cursor-pointer', active ? 'text-accent-gold' : 'text-text-muted hover:text-text-secondary')}
            >
