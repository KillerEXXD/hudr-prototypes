...
export const THEMES: Record<ThemeName, ThemeDef> = {
  ...
  felt: {
    name: 'felt', label: 'Table', tagline: 'In-session — big-touch, glanceable from across the felt',
    flags: {},
    swatch: { bg: '#06140E', accent: '#34E89E', text: '#FFFFFF' },
    vars: {
      '--color-bg-primary': '#06140E', '--color-bg-secondary': '#030B07', '--color-bg-card': '#0C2218',
      '--color-bg-surface': '#123022', '--color-bg-elevated': '#1A4030', '--color-border': '#1B3A2A', '--color-border-light': '#27523C',
      '--color-text-primary': '#FFFFFF', '--color-text-secondary': '#B7D6C6', '--color-text-muted': '#6FA088',
      '--color-accent-blue': '#54C7FF', '--color-accent-blue-deep': '#2E8FC9', '--color-accent-amber': '#FFC23D',
      '--color-accent-emerald': '#34E89E', '--color-accent-red': '#FF5C6C', '--color-accent-purple': '#B98BFF', '--color-accent-cyan': '#34E89E',
      '--color-accent-gold': '#34E89E', '--color-accent-gold-deep': '#1FBE7E',
      '--color-tier-reliable': '#34E89E', '--color-tier-tentative': '#FFC23D', '--color-tier-noise': '#6FA088',
      '--color-sev-critical': '#FF5C6C', '--color-sev-moderate': '#FFC23D', '--color-sev-minor': '#54C7FF',
