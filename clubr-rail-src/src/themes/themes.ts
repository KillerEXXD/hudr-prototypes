...
export const THEMES: Record<ThemeName, ThemeDef> = {
  ...
  felt: {
    name: 'felt', label: 'Rail', tagline: 'Social-first — your crews, not your games',
    flags: {},
    swatch: { bg: '#17120F', accent: '#FF7A59', text: '#F6F1EC' },
    vars: {
      '--color-bg-primary': '#17120F', '--color-bg-secondary': '#0F0B09', '--color-bg-card': '#211915',
      '--color-bg-surface': '#2A201B', '--color-bg-elevated': '#352822', '--color-border': '#3A2C24', '--color-border-light': '#4A382E',
      '--color-text-primary': '#F6F1EC', '--color-text-secondary': '#C9B8AC', '--color-text-muted': '#8C7A6E',
      '--color-accent-blue': '#5AA9E6', '--color-accent-blue-deep': '#2E6FA3', '--color-accent-amber': '#FFB155',
      '--color-accent-emerald': '#4FCB8B', '--color-accent-red': '#FF7A59', '--color-accent-purple': '#C08BE6', '--color-accent-cyan': '#4FB8C9',
      '--color-accent-gold': '#FF7A59', '--color-accent-gold-deep': '#E0613F',
      '--color-tier-reliable': '#4FCB8B', '--color-tier-tentative': '#FFB155', '--color-tier-noise': '#8C7A6E',
      '--color-sev-critical': '#FF6B5C', '--color-sev-moderate': '#FFB155', '--color-sev-minor': '#5AA9E6',
      '--font-family-sans': F.jakarta, '--font-family-mono': F.plexMono, '--font-family-display': F.jakarta,
    },
  },
  pulse: {
