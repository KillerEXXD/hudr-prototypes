...
export const THEMES: Record<ThemeName, ThemeDef> = {
  ...
  felt: {
    name: 'felt', label: 'Ledger', tagline: 'Grinder stats cockpit — mono numerals, one sharp accent',
    flags: { mono: true },
    swatch: { bg: '#0C0F12', accent: '#B6F36B', text: '#E9EEF2' },
    vars: {
      '--color-bg-primary': '#0C0F12', '--color-bg-secondary': '#080A0C', '--color-bg-card': '#13181D',
      '--color-bg-surface': '#1A2128', '--color-bg-elevated': '#222B33', '--color-border': '#222A31', '--color-border-light': '#303A43',
      '--color-text-primary': '#E9EEF2', '--color-text-secondary': '#9DAAB5', '--color-text-muted': '#5F6E79',
      '--color-accent-blue': '#5AA9E6', '--color-accent-blue-deep': '#2E6FA3', '--color-accent-amber': '#E9B44C',
      '--color-accent-emerald': '#5BD08A', '--color-accent-red': '#F0664F', '--color-accent-purple': '#9D8BE6', '--color-accent-cyan': '#4FD0C9',
      '--color-accent-gold': '#B6F36B', '--color-accent-gold-deep': '#8FCB48',
      '--color-tier-reliable': '#5BD08A', '--color-tier-tentative': '#E9B44C', '--color-tier-noise': '#5F6E79',
      '--color-sev-critical': '#F0664F', '--color-sev-moderate': '#E9B44C', '--color-sev-minor': '#5AA9E6',
      '--font-family-sans': F.plexSans, '--font-family-mono': F.plexMono, '--font-family-display': F.plexSans,
    },
  },
  pulse: {
