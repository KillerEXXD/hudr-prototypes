  ...
  return (
    <Section title="The Final Table" action={<Badge tone="purple">{players.length}-handed</Badge>}>
      ...
      <div className="mb-2 grid grid-cols-2 gap-2">
        <Fact icon={<Trophy className="h-3.5 w-3.5 text-accent-amber" />} label="Prize pool" value={c.prizePool ? `${c.prizePool} Stakes` : '—'} />
        <Fact icon={<Coins className="h-3.5 w-3.5 text-accent-emerald" />} label="Buy-in" value={c.buyIn ? `${c.buyIn} Stakes` : '—'} />
