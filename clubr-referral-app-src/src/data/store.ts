...
export const USERS: Record<string, User> = {
  ...
  u_host: { id: 'u_host', name: 'Harper Host', handle: 'harper', email: 'harper@aceshigh.club', location: 'Houston, TX', role: 'owner', avatarColor: '#10b981', emailVerified: true },
  u_player: { id: 'u_player', name: 'Sam Rivers', handle: 'sam', email: 'sam@example.com', phone: '+1 (415) 555‑0182', location: 'Houston, TX', role: 'member', avatarColor: '#3b82f6', emailVerified: true },
  u_gary: { id: 'u_gary', name: 'Gary Grind', handle: 'gary', email: 'gary@grinders.club', phone: '+1 (312) 555‑0143', location: 'Dallas, TX', role: 'owner', avatarColor: '#f59e0b' },
  u_rae: { id: 'u_rae', name: 'Rae Rivers', handle: 'rae', email: 'rae@riverrats.club', location: 'Austin, TX', role: 'owner', avatarColor: '#06b6d4' },
  u_mike: { id: 'u_mike', name: 'Mike Jones', handle: 'mikej', email: 'mike@example.com', phone: '+1 (646) 555‑0110', location: 'Houston, TX', role: 'member', avatarColor: '#ef4444' },
  u_tom: { id: 'u_tom', name: 'Tom Wilson', handle: 'tomw', email: 'tom@example.com', phone: '+1 (702) 555‑0177', location: 'Dallas, TX', role: 'member', avatarColor: '#ec4899' },
  u_lena: { id: 'u_lena', name: 'Lena Park', handle: 'lena', email: 'lena@example.com', phone: '+1 (213) 555‑0199', location: 'Austin, TX', role: 'member', avatarColor: '#14b8a6' },
  ...
  u_cc_p1: { id: 'u_cc_p1', name: 'Joon Park', handle: 'joonpark', email: 'joon@example', location: 'Austin, TX', role: 'member', avatarColor: '#ef4444' },
  u_cc_p2: { id: 'u_cc_p2', name: 'Harry Wright', handle: 'harryw', email: 'harry@example', location: 'De Queen, AR', role: 'member', avatarColor: '#f97316' },
  u_cc_p3: { id: 'u_cc_p3', name: 'Kevin Kaylor', handle: 'kevink', email: 'kevin@example', location: 'Houston, TX', role: 'member', avatarColor: '#eab308' },
  u_cc_p4: { id: 'u_cc_p4', name: 'Michael Wang', handle: 'mwang', email: 'mwang@example', location: 'Livingston, NJ', role: 'member', avatarColor: '#22c55e' },
  u_cc_p5: { id: 'u_cc_p5', name: 'Shawn Rice', handle: 'shawnr', email: 'shawn@example', location: 'Lubbock, TX', role: 'member', avatarColor: '#14b8a6' },
  u_cc_p6: { id: 'u_cc_p6', name: 'Gabriel Andrade', handle: 'gabea', email: 'gabe@example', location: 'Houston, TX', role: 'member', avatarColor: '#06b6d4' },
  u_cc_p7: { id: 'u_cc_p7', name: 'Nick Shkolnik', handle: 'nicks', email: 'nick@example', location: 'Sun Valley, CA', role: 'member', avatarColor: '#3b82f6' },
  u_cc_p8: { id: 'u_cc_p8', name: 'Christopher Doan', handle: 'chrisd', email: 'chris@example', location: 'Hacienda Heights, CA', role: 'member', avatarColor: '#8b5cf6' },
  u_cc_p9: { id: 'u_cc_p9', name: 'Jared Hemingway', handle: 'jaredh', email: 'jaredh@example', location: 'Houston, TX', role: 'member', avatarColor: '#ec4899' },
  // Gulf Coast Card Club members — real Trailblazer $1M Main Event field (finishing order).
  u_tch_p1: { id: 'u_tch_p1', name: 'Travis Preng', handle: 'travisp', email: 'travis@example', location: 'Dallas, TX', role: 'member', avatarColor: '#ef4444' },
  u_tch_p2: { id: 'u_tch_p2', name: 'Young Ki Choi', handle: 'youngki', email: 'young@example', location: 'Dallas, TX', role: 'member', avatarColor: '#f97316' },
  u_tch_p3: { id: 'u_tch_p3', name: 'Paul Velasco', handle: 'paulv', email: 'paul@example', location: 'Houston, TX', role: 'member', avatarColor: '#eab308' },
  u_tch_p4: { id: 'u_tch_p4', name: 'Jared Ingles', handle: 'jaredi', email: 'jaredi@example', location: 'Austin, TX', role: 'member', avatarColor: '#22c55e' },
  u_tch_p5: { id: 'u_tch_p5', name: 'Mariona Canals Riba', handle: 'mariona', email: 'mariona@example', location: 'Barcelona, ES', role: 'member', avatarColor: '#14b8a6' },
  u_tch_p6: { id: 'u_tch_p6', name: 'Tyler Rawlinson', handle: 'tylerr', email: 'tyler@example', location: 'Dallas, TX', role: 'member', avatarColor: '#06b6d4' },
  u_tch_p7: { id: 'u_tch_p7', name: 'Brian Devany', handle: 'briand', email: 'brian@example', location: 'Houston, TX', role: 'member', avatarColor: '#3b82f6' },
  u_tch_p8: { id: 'u_tch_p8', name: 'Damien Dreyer', handle: 'damiend', email: 'damien@example', location: 'Austin, TX', role: 'member', avatarColor: '#8b5cf6' },
...
export const CLUBS: Club[] = [
  {
    ...
    creatorId: 'u_host', ownerId: 'u_host', ownerName: 'Harper Host', inviteCode: 'ACES24', createdAt: '2026-05-02',
    members: [
  ...
  },
  {
    ...
    location: 'Dallas, TX',
    creatorId: 'u_gary', ownerId: 'u_gary', ownerName: 'Gary Grind', inviteCode: 'GRIND7', createdAt: '2026-04-18',
    members: [
  ...
  },
  {
    ...
    location: 'Austin, TX',
    creatorId: 'u_rae', ownerId: 'u_rae', ownerName: 'Rae Rivers', inviteCode: 'RIVER1', createdAt: '2026-06-08',
    members: [
  ...
  },
  {
    ...
    location: 'Dallas, TX',
    creatorId: 'u_gary', ownerId: 'u_gary', ownerName: 'Gary Grind', inviteCode: 'FELT99', createdAt: '2026-06-10',
  ...
  },
  {
    ...
    creatorId: 'u_rae', ownerId: 'u_rae', ownerName: 'Rae Rivers', inviteCode: 'HRX7K2Q9', createdAt: '2026-06-11',
  ...
  // ---- Demo: Bayou City Poker Club (real final-table data in its FT) ----
  {
    ...
    location: 'Houston, TX',
    creatorId: 'u_cc_host', ownerId: 'u_cc_host', ownerName: 'Marcus Reyes', inviteCode: 'CHAMP1', createdAt: '2026-05-10',
    members: [
  ...
  // ---- Demo: Gulf Coast Card Club (real final-table data in its FT) ----
  {
    ...
    location: 'Houston, TX',
    creatorId: 'u_tch_host', ownerId: 'u_tch_host', ownerName: 'Diana Cole', inviteCode: 'TCH777', createdAt: '2026-05-08',
    members: [
