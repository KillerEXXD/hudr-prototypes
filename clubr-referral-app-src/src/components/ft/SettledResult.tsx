          ...
          <div className={cn('relative overflow-hidden rounded-2xl border p-4 text-center', wta ? 'border-accent-amber/50 bg-gradient-to-br from-accent-amber/25 via-accent-amber/10 to-bg-card' : 'border-accent-purple/40 bg-gradient-to-br from-accent-purple/20 to-bg-card')}>
            ...
            <div className="relative flex items-center justify-center gap-2.5">
              ...
              <div className="text-left">
                ...
                <div className="truncate text-xs text-text-secondary">{winner.score} pts · <span className="text-text-muted">Picks:</span> {picksToNames(winner.picks, c.players)}</div>
              </div>
            </div>
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="truncate text-[11px] text-text-muted"><span className="font-semibold uppercase tracking-wide">Picks:</span> {picksToNames(e.picks, c.players)}</p>
                </div>
