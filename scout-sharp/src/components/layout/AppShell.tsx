        ...
        <header className="sticky top-0 z-30 border-b border-border bg-bg-secondary/85 backdrop-blur supports-[backdrop-filter]:bg-bg-secondary/70">
          <div className="flex items-center justify-between gap-2 px-3 py-2.5">
            <div className="flex min-w-0 items-center gap-2">
              {atHome ? (
                <Link to="/" aria-label="Scout Sharp home" className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-bold tracking-tight text-text-primary">Scout <span className="text-accent-blue">Sharp</span></span>
                </Link>
              ) : (
                <button
                  onClick={() => navigate(-1)}
