...
// 3 content/discovery destinations. Detail routes light up their parent tab
...
// Scout Sharp has a single AI surface — the in-report "Ask AI" chat — so there
// is no standalone AI tab here.
const navItems = [
